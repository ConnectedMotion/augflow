# tests_individual_augmentations/test_rotate.py
...
def test_rotate_augmentation_edge_cases():
    """
    Test the RotateAugmentation class with all configurations and edge cases for both detection and segmentation tasks.
    """
    ...
    for task in tasks:
        ...
        rotate_configs = [
            ...
            #     'modes': ['non_targeted'],
            #     'config': {
            #         'rotation_probability': 1.0,  # Ensure rotation is applied
            #         'rotation_point_modes': ['TL', 'TR', 'BL', 'BR', 'center', 'random'],
            #         'rotation_angle_modes': ['predefined_set'],
            #         'angle_parameters': {
            #             'predefined_set': [-30, 30, -45, 45, 90, 180, 270],
            #             'alpha': 45
            #         },
